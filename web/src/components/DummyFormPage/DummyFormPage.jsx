...
const DummyFormPage = () => {
  ...
  const { submitPersonalInfo, loading, error, successMessage } =
    useSubmitPersonalInfo(); // Use the hook
          ...
          <Education
            ...
            onEducationChange={(data) =>
              setFormData((prevState) => ({
                ...prevState,
                education: Array.isArray(data) ? data : [data], // Ensure it's an array
              }))
            }
          />
        );
        ...
        return (
          <Project
            ...
            onProjectChange={(data) =>
              setFormData((prevState) => ({
                ...prevState,
                projects: Array.isArray(data) ? data : [data], // Ensure it's an array
              }))
            }
          />
        );
